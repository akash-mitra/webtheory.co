                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="align-baseline">
                        <tr v-for="plan in plans" :class="selected==plan.id ? ' border-t border-b border-green-200 bg-green-300' : ''">
                            ...
                            <td class="px-4 py-2 align-middle text-xs text-center font-bold border-indigo-500 text-white bg-indigo-400" v-if="subscribed_plan === plan.id">Y</td>
                    ...
                    <div class="bg-blue-100 shadow border rounded-lg px-6 py-10">
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                ...
                                <label for="site_name" class="inline-block text-sm text-gray-700 font-semibold mb-2">{{ __('Site Name') }}</label>
                        ...
                        <button id="card-button" type="submit"
                            class="inline-block w-full px-4 py-3 mb-4 text-white rounded-lg bg-indigo-500 hover:bg-green-500"
