...
Route::get('google2fa/enable', 'Auth\Google2FAController@enable')->name('google2fa.enable');
Route::get('google2fa/validate', 'Auth\LoginController@getToken')->name('google2fa.token');
Route::post('google2fa/validate', ['middleware' => 'throttle:5', 'uses' => 'Auth\LoginController@validateToken'])->name('google2fa.validate');
Route::get('google2fa/disable', 'Auth\Google2FAController@disable')->name('google2fa.disable');
...
Route::patch('subscriptions/{plan}', 'SubscriptionController@update')->name('subscriptions.update');
Route::delete('subscriptions/{plan}', 'SubscriptionController@destroy')->name('subscriptions.destroy');
